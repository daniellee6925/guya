...
| `guya-audit/SKILL.md` | guya-audit | Whole-repo rot audit → GitHub issues. Deterministic scanner + 12-angle agent fan-out; files via `/guya-issue` batch mode. Unattended-safe; never fixes |
