...
## SDF (Synthetic Data Factory) — PRIMARY
- Plugin-based pipeline for generating synthetic conversational training data at scale (~100k conversations)
- Insurance sales domain first, designed to be domain-agnostic
- Python 3.11, async, multi-LLM (Claude/OpenAI/Gemini), SQLite, Click CLI
